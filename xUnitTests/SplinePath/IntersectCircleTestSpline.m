classdef IntersectCircleTestSpline < matlab.unittest.TestCase
    ...
    methods (Test)
        function testNoIntersection(testCase, DoPlot)
            ...
            [xy,tau] = obj0.intersectCircle([1 1], 0.5, DoPlot);
        ...
        function testSingleIntersection(testCase, DoPlot)
            obj0 = SplinePath([0 1 2], reshape([1 0; 0 0; 1 1; 1 0],2,2,2));
            [act,tau] = obj0.intersectCircle([2 1], 1, DoPlot);
        ...
        function testTerminalIntersections(testCase, DoPlot)
            ...
            [act,tau] = intersectCircle(obj0, [3 4], 1, DoPlot);
            exp = [2 4];
